    ...
    public override void OnCreatedRoom()
{
    ...
    public override void OnJoinedRoom(){
        ...
        if(playerNum <= playerSpawnPoints.Length) startRig.transform.SetPositionAndRotation(playerSpawnPoints[playerNum].transform.position, playerSpawnPoints[playerNum].transform.rotation);
        else startRig.transform.SetPositionAndRotation(playerSpawnPoints[0].transform.position, playerSpawnPoints[playerNum].transform.rotation);
